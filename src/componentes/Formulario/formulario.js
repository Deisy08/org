...
const Formulario = (props) => {
    ...
    return <section className="formulario">
        <form onSubmit={manejarEvento}>
            ...
            <Campo  titulo="Nombre" placeholder="Ingrese su nombre" required 
                valor={nombre} 
            ...
            />
            <ListaOpciones titulo="Equipos" placeholder="Seleccionar equipo" 
        ...
        <form onSubmit={manejarNuevoEquipo}>
            ...
            <Campo  titulo="Titulo" placeholder="Ingrese su titulo" required 
                valor={titulo} 
